        ...
        <div className="searchbar">
            <div className="conteneur">
                <div className="form">
                    ...
                    <input type="text" formMethod="post" className="form-input" placeholder="Rechercher ..." />
                    <svg className="micro-icon iconsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                        <path
